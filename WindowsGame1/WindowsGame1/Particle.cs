...
namespace WindowsGame1 {
    public class Particle {
        ...
        private float FadeRate { get; set; }         // The fading rate of the particle, they can dissapear/apper smoothly with this
        private float SizeRate { get; set; }         // The size rate of the particle to make them bigger/smaller over time
    
        public Particle(Texture2D texture, Vector2 position, Vector2 velocity,
            float angle, float angularVelocity, Color color, float size, int ttl, float fadeValue, float fadeRate, float sizeRate) {
                Texture = texture;
                Position = position;
                Velocity = velocity;
                Angle = angle;
        ...
        public void Draw(SpriteBatch spriteBatch) {
            ...
            spriteBatch.Draw(Texture, Position, sourceRectangle, Color*FadeValue,
